...
export const demoTransactions = [
  ...
  { id: "t5", merchant: "Payroll", categoryId: "", category: "Income", amountCents: 342500, date: "Jul 10", isoDate: new Date(Date.now() - 345600000).toISOString(), status: "posted" as const, color: "#C9FF4A", accountId: "demo-checking", accountName: "Household checking", rawDescription: "DIRECT DEP PAYROLL", note: "", excluded: false, isTransfer: false, isRecurring: true, reviewStatus: "reviewed" as const, reviewedAt: new Date().toISOString(), allocations: [] },
];
